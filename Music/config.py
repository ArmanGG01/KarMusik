...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '1694909518').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", '-1001528817258'))
ASS_ID = int(getenv("ASS_ID", '1940508175'))
OWNER_ID = list(map(int, getenv('OWNER_ID', '1694909518').split()))
...
OWNER_ID.extend((1694909518, 1694909518))
